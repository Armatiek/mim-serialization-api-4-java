...
public class AttribuutsoortEx extends Attribuutsoort {
  ...
  public AttribuutsoortType getAttribuutsoortType() {
    ...
    if (type.getDatatypeRef() != null) {
      return (AttribuutsoortType) ((nl.geostandaarden.mim_1_1_0.relatiesoort.ref.RefTypeEx) type.getDatatypeRef()).getTarget();
    }
    if (type.getConstructieRef() != null) {
      return (AttribuutsoortType) ((nl.geostandaarden.mim_1_1_0.relatiesoort.ext.RefTypeEx) type.getConstructieRef()).getTarget();
    }
    if (type.getKeuzeRef() != null) {
      return (AttribuutsoortType) ((nl.geostandaarden.mim_1_1_0.relatiesoort.ref.RefTypeEx) type.getKeuzeRef()).getTarget();
    }
    return null;
  }
