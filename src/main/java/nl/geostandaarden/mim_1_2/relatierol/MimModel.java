...
public class MimModel extends nl.geostandaarden.mim.MimModel {
  ...
  public Object getModelElementByRefType(nl.geostandaarden.mim_1_2.relatierol.ext.RefType refType) {
    return super.getModelElementById(refType.getHref().substring(1));
  }
  
  public Object getModelElementByRefType(nl.geostandaarden.mim_1_2.relatierol.ref.RefType refType) {
    return super.getModelElementById(refType.getHref().substring(1));
  }
