...
public class MimModel extends nl.geostandaarden.mim.MimModel {
  ...
  public MIM_VERSION getMimVersie() {
    return MIM_VERSION.VERSION_1_2;
  }
  ...
  public Object getModelElementByRefType(nl.geostandaarden.mim_1_2.relatiesoort.ext.RefType refType) {
    return super.getModelElementById(refType.getHref().substring(1));
  }
  
  public Object getModelElementByRefType(nl.geostandaarden.mim_1_2.relatiesoort.ref.RefType refType) {
    return super.getModelElementById(refType.getHref().substring(1));
  }
